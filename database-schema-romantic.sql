...
DROP POLICY IF EXISTS "Users can view their memories" ON memories;
CREATE POLICY "Users can view their memories" ON memories
  FOR SELECT USING (auth.uid() = user_id OR auth.uid() = partner_id);

DROP POLICY IF EXISTS "Users can insert their memories" ON memories;
CREATE POLICY "Users can insert their memories" ON memories
  FOR INSERT WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their memories" ON memories;
CREATE POLICY "Users can update their memories" ON memories
  FOR UPDATE USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can delete their memories" ON memories;
CREATE POLICY "Users can delete their memories" ON memories
  FOR DELETE USING (auth.uid() = user_id);

-- 11. RLS Policies untuk love_notes
DROP POLICY IF EXISTS "Users can view received love notes" ON love_notes;
CREATE POLICY "Users can view received love notes" ON love_notes
  FOR SELECT USING (auth.uid() = receiver_id OR auth.uid() = sender_id);

DROP POLICY IF EXISTS "Users can send love notes" ON love_notes;
CREATE POLICY "Users can send love notes" ON love_notes
  FOR INSERT WITH CHECK (auth.uid() = sender_id);

DROP POLICY IF EXISTS "Users can update their sent love notes" ON love_notes;
CREATE POLICY "Users can update their sent love notes" ON love_notes
  FOR UPDATE USING (auth.uid() = sender_id);

DROP POLICY IF EXISTS "Users can mark love notes as read" ON love_notes;
CREATE POLICY "Users can mark love notes as read" ON love_notes
  FOR UPDATE USING (auth.uid() = receiver_id);

-- 12. RLS Policies untuk daily_questions
DROP POLICY IF EXISTS "Users can view their questions" ON daily_questions;
CREATE POLICY "Users can view their questions" ON daily_questions
  FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their questions" ON daily_questions;
CREATE POLICY "Users can insert their questions" ON daily_questions
  FOR INSERT WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their questions" ON daily_questions;
CREATE POLICY "Users can update their questions" ON daily_questions
  FOR UPDATE USING (auth.uid() = user_id);

-- 13. RLS Policies untuk mood_tracker
DROP POLICY IF EXISTS "Users can view their mood" ON mood_tracker;
CREATE POLICY "Users can view their mood" ON mood_tracker
  FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their mood" ON mood_tracker;
CREATE POLICY "Users can insert their mood" ON mood_tracker
  FOR INSERT WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their mood" ON mood_tracker;
CREATE POLICY "Users can update their mood" ON mood_tracker
  FOR UPDATE USING (auth.uid() = user_id);

-- 14. RLS Policies untuk streaks
DROP POLICY IF EXISTS "Users can view their streaks" ON streaks;
CREATE POLICY "Users can view their streaks" ON streaks
  FOR SELECT USING (auth.uid() = user_id OR auth.uid() = partner_id);

DROP POLICY IF EXISTS "Users can insert their streaks" ON streaks;
CREATE POLICY "Users can insert their streaks" ON streaks
  FOR INSERT WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their streaks" ON streaks;
